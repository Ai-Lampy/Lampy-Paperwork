...
assert(html.includes('-webkit-text-stroke-width:var(--power-position-stroke-width,0)!important'));
assert(html.includes('font-size:14px!important;font-weight:900!important;color:inherit!important'));
...
assert(fs.readFileSync(root+'tests/BROWSER-CHECKLIST.md','utf8').startsWith('# V49 browser release checks'));
console.log('PASS: V49 unified Control sections, independent table state, shared interactions and Power Position location styling.');
