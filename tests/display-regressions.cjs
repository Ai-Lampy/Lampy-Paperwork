...
assert(html.includes('<title>Lampy Paperwork V33.15</title>'));
...
// V33.15 Fixture Patch fixed min/max widths and spreadsheet editing.
assert(html.includes('<title>Lampy Paperwork V33.15</title>'));
...
console.log('PASS: V33.15 Fixture Patch fixed min/max widths, Device Config editing and three-line text fitting.');
