...
assert(html.includes('.distroLabelNav{justify-content:space-between;background:#b9b9b9;border:2px solid #000'));
assert(html.includes('.sheetTabs{width:100%;justify-content:center;border:2px solid #000'));
