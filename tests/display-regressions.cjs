...
// V40.8 applies Control outlines and preserves valid Loom parent relationships when changing type.
assert.equal(appVersion,'40.8');
...
console.log('PASS: V40.8 Control outlines and Loom type editing.');
