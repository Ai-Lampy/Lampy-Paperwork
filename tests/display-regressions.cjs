...
// V43.2 applies the shared white-band outline in Power Calcs, Fan Outs and Looms.
assert.equal(appVersion,'43.2');
assert(source('powerPositionCellStyle').includes("positionStripeBands(colours,stripeWidth,'mm')"));
...
assert(source('fanOutSlotCellsMarkup').includes('powerPositionCellStyle(result)'));
assert(source('drawPositionSummaryStripeFill').includes('.5*PDF_MM_TO_PT'));
console.log('PASS: V43.2 Power Calcs, Fan Outs and Looms outline white multi-colour bands.');
