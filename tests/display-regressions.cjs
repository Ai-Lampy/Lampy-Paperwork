...
assert(source('renderLoomsView').includes('Edit Loom')&&source('renderLoomsView').includes('Delete Loom'));
...
assert.equal(appVersion,'40.1');
assert(html.includes('.loomSubTabs{display:flex;align-items:center;justify-content:center;gap:8px;flex-wrap:wrap;margin:0}'));
...
assert(source('renderLoomsView').includes('<div class="loomsToolbar"><strong>Looms</strong>${tabs}'));
