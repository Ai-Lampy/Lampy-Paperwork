...
assert(html.includes('<title>Lampy Paperwork V33.14</title>'));
...
// V33.14 Fixture Patch fixed min/max widths and text fitting.
assert(html.includes('<title>Lampy Paperwork V33.14</title>'));
...
console.log('PASS: V33.14 Fixture Patch fixed min/max widths, fixed colour columns and three-line text fitting.');
