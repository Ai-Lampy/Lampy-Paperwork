...
assert.equal(appVersion,'40.3');
assert(html.includes('.loomGroup{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px;align-items:start}.loomCard{width:100%;border:2px solid #000'));
...
assert(source('loomDisplayGroups').includes('flatMap(expand)'));
