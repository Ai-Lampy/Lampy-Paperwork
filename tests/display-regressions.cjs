...
assert(html.includes('.loomTable tbody td{height:20px;border:0}.loomTable tbody td[data-loom-cell]{border-bottom:1px dashed #9b9b9b}'));
...
assert(html.includes('.loomCardHeading{cursor:pointer;position:relative;display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:10px;height:40px;min-height:40px;padding:0 12px;background:var(--loom-background,#fff)'));
assert(html.includes('.loomTable th:first-child,.loomTable td:first-child{border-left:none}'));
assert(html.includes('.loomTable th:last-child,.loomTable td:last-child{width:30px;min-width:30px;max-width:30px;padding:1px;border-right:none}'));
assert(html.includes('.loomEndsTogetherRow td{color:#c00000;font-weight:900;border-top:2px solid #000!important}'));
assert(html.includes('.loomTable tbody td[data-loom-cell]{border-bottom:1px dashed #9b9b9b}'));
