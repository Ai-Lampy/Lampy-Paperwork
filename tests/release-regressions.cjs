...
assert(html.includes('<title>Lampy Paperwork V49.5</title>'));
assert(html.includes("const VERSION='49.5';"));
...
assert(changelog.startsWith('## V49.5 — Power Socapex two-colour pattern'));
assert(html.includes("const VERSION='49.5';"));
...
assert(fs.readFileSync(path.join(root,'CHANGELOG.md'),'utf8').startsWith('## V49.5 — Power Socapex two-colour pattern'));
...
assert(fs.readFileSync(path.join(root,'CHANGELOG.md'),'utf8').startsWith('## V49.5 — Power Socapex two-colour pattern'));
console.log('PASS: V49.5 Socapex two-colour pattern release metadata.');
