...
assert(html.includes('<title>Lampy Paperwork V50.5</title>'));
assert(html.includes("const VERSION='50.5';"));
...
assert(changelog.startsWith('## V50.5 — GDTF mode parameter counts'));
assert(html.includes("const VERSION='50.5';"));
...
assert(fs.readFileSync(path.join(root,'CHANGELOG.md'),'utf8').startsWith('## V50.5 — GDTF mode parameter counts'));
