...
assert(html.includes('<title>Lampy Paperwork V49.4</title>'));
assert(html.includes("const VERSION='49.4';"));
...
assert(changelog.startsWith('## V49.4 — Position Summary PDF colours'));
assert(html.includes("const VERSION='49.4';"));
...
assert(fs.readFileSync(path.join(root,'CHANGELOG.md'),'utf8').startsWith('## V49.4 — Position Summary PDF colours'));
