...
assert(html.includes('<title>Lampy Paperwork V50.2</title>'));
assert(html.includes("const VERSION='50.2';"));
...
assert(changelog.startsWith('## V50.2 — Highlight-based PDF Patch Import'));
assert(html.includes("const VERSION='50.2';"));
...
assert(fs.readFileSync(path.join(root,'CHANGELOG.md'),'utf8').startsWith('## V50.2 — Highlight-based PDF Patch Import'));
