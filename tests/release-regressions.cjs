...
assert(html.includes('<title>Lampy Paperwork V50.7</title>'));
assert(html.includes("const VERSION='50.7';"));
...
assert(changelog.startsWith('## V50.7 — Fixture Summary totals and notes'));
assert(html.includes("const VERSION='50.7';"));
...
assert(fs.readFileSync(path.join(root,'CHANGELOG.md'),'utf8').startsWith('## V50.7 — Fixture Summary totals and notes'));
