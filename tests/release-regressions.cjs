...
assert(html.includes('<title>Lampy Paperwork V50.6</title>'));
assert(html.includes("const VERSION='50.6';"));
...
assert(changelog.startsWith('## V50.6 — Fixture Summary and merged patch columns'));
assert(html.includes("const VERSION='50.6';"));
...
assert(fs.readFileSync(path.join(root,'CHANGELOG.md'),'utf8').startsWith('## V50.6 — Fixture Summary and merged patch columns'));
