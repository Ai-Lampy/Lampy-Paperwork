...
Fixture Patch shows temporary browser-session min/max width controls above its first table header. They apply to the live table and PDF output; Col 1 and Col 2 remain fixed at 110 px. Text shrinks to 8 px before using up to three wrapped lines.
