...
Fixture Patch uses fixed min/max column widths in the live table and PDF output: #, Uni and Add 45–80 px; Type 80–220 px; Mode 90–280 px; Chan 45–80 px; Position 90–300 px; Notes 90–150 px. Col 1 and Col 2 remain fixed at 110 px. Text shrinks to 8 px before using up to three wrapped lines.
